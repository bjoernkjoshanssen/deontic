...
Definition \ref{{canon₂}} introduces canon$_2$, a ``canonical'' model of some of Carmo and Jones' axioms with two parameters:
...
\begin{definition}\label{canon₂_II}
    \lean{canon₂_II}
    \leanok
    canon₂\_II A B X = if X ∩ B = ∅ then ∅, else: if X ∩ A = ∅ then
