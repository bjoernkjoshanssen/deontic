...
\begin{lemma}\label{alive_of_no_bad}
	\lean{alive_of_no_bad}
	\leanok
...
\begin{lemma}\label{obSelf_of_bad_nonsingle}
	\lean{obSelf_of_bad_nonsingle}
	\leanok
...
\begin{lemma}\label{obSelf_of_bad}
	\lean{obSelf_of_bad}
	\leanok
	\uses{obSelfSingleton_of_bad,obSelf_of_bad_nonsingle}
...
\begin{lemma}\label{models_ofCJ_1997}
	...
	\leanok
	\uses{stayAlive_of_bad,alive_of_no_bad,bad_of_semibad}
